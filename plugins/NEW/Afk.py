...
from info import SECOND_URI, SECOND_NAME
...
async def active_afk(client, message: Message):
...
async def chat_watcher_func(client, message):
    if message.sender_chat:
        return
