...
# @Client.on_message(filters.regex(r'https?://.*youtube[^\s]+') & filters.incoming|filters.regex(r'(https?:\/\/(?:www\.)?youtu\.?be(?:\.com)?\/.*)') & filters.incoming)
@Client.on_message(filters.command(['ytmp3']) & filters.private)
async def ytdlsong(client, message):
...
async def ytdlvideo(client, message: Message):
