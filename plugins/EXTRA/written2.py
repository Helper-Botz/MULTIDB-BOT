...
# PIC = "https://graph.org/file/b2991d3bdcb6558655d39.jpg"
...
@Client.on_message(filters.command(["handwrite"], COMMAND_HANDLER))
async def handwrite(client, message):
    ...
    try:
        img = Image.open("plugins/helpers/kertas.jpg")
        draw = ImageDraw.Draw(img)
        font = ImageFont.truetype("plugins/helpers/assfont.ttf", 30)
        x, y = 150, 140
        lines = text_set(txt)
