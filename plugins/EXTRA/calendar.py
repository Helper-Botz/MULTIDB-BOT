...
@Client.on_message(filters.command("calendar", prefixes="/"))
async def send_calendar(bot, message):
    ...
    await bot.send_photo(message.chat.id, carbon_image, caption=f"Calendar for the year {year}")
