...
from plugins.helpers.config import OPENAI_API, LOG_CHANNEL, AI
...
#--------------------------------------------------------------------------
#--------------------------------------------------------------------------
@Client.on_message(filters.command(["aby" , ],  prefixes=["+", ".", "/", "-", "?", "$","#","&"]))
async def aby(client, message):
...
@Client.on_message(filters.command(["assist"],  prefixes=["+", ".", "/", "-", "?", "$","#","&"]))
...
@Client.on_message(filters.command("bingsearch"))
